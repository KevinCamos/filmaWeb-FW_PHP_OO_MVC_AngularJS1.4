...
define('SITE_PATH_APP_LEVEL', 'http://' . $_SERVER['HTTP_HOST'] . PROJECT); // Site Path


define('SITE_ROOT', $_SERVER['DOCUMENT_ROOT'] . PROJECTBACK); // Site Root
define('SITE_PATH', 'http://' . $_SERVER['HTTP_HOST'] . PROJECTBACK); // Site Path

define('VIEW_PATH', SITE_PATH_APP_LEVEL . 'view/'); // Css Path
define('ASSETS_PATH', SITE_PATH_APP_LEVEL . 'assets/'); // Css Path
define('ASSETS_PATH_PHP', SITE_ROOT_APP_LEVEL . 'assets/'); // Css Path
