...
function validate_price(valueText) {
  if (valueText.length == 0) {
    ...
    $("#error_price").html("*Escribe una cantidad utilizando símbolos numéricos");
  } else {
    $("#error_price").html("");
  }
}
...
function validate_movies() {
  ...
  if (document.getElementById("error_movie").textContent == "" && document.getElementById("error_ref").textContent == "" && document.getElementById("error_director").textContent == "" && document.getElementById("error_email").textContent == "" && document.getElementById("error_format").textContent == "" && document.getElementById("error_awards").textContent == "" && document.getElementById("error_genere").textContent == "" && document.getElementById("error_date").textContent == "" && document.getElementById("error_price").textContent == "" && document.getElementById("error_img").textContent == "") {
    console.log("siiii");
