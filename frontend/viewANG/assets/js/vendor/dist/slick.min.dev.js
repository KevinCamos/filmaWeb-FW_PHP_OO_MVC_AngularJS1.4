...
!function (a) {
  ...
  "function" == typeof define && define.amd ? define(["jquery"], a) : "undefined" != typeof exports ? module.exports = a(include("jquery")) : a(jQuery);
}(function (a) {
  "use strict";
    ...
    function c(c, d) {
      ...
      e.defaults = {
        ...
        customPaging: function customPaging(a, b) {
          return '<button type="button" data-role="none" role="button" aria-included="false" tabindex="0">' + (b + 1) + "</button>";
        },
        dots: !1,
