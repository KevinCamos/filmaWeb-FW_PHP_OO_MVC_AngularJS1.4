...
getyourcar.controller('controller_shop', function ($scope, services, filters, cars, favs, cart, services_shop) {
  ...
  function setPage(carsVal, currentPageVal) {
    var filteredCarsVal = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : undefined;
    var currentCarsVal = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : undefined;
